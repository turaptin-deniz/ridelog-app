        ...
        {showSettings && (
          ...
          >
            ...
            >
              ...
              {/* Other settings */}
              {[
                { label: T('settings_privacy'), icon: '🔒', action: () => { setShowSettings(false); setShowPrivacy(true) } },
        ...
        {showPrivacy && (
          <div onClick={() => setShowPrivacy(false)} style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.75)', zIndex: 3100, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '20px' }} className="animate-fadeIn">
            <div onClick={e => e.stopPropagation()} style={{ width: '100%', maxWidth: '360px', background: t.surface, borderRadius: '16px', padding: '24px', border: `1px solid ${t.border}` }} className="animate-scaleIn">
              ...
              {[
                { id: 'public',    icon: '🌍', label: 'Öffentlich',     desc: 'Jeder kann dein Profil und deine Touren sehen' },
                { id: 'followers', icon: '👥', label: 'Nur Follower',   desc: 'Nur Nutzer die du folgst und die dir folgen' },
                { id: 'private',   icon: '🔒', label: 'Privat',         desc: 'Niemand außer dir kann dein Profil sehen' },
              ].map(opt => (
                <button key={opt.id} onClick={() => savePrivacyLevel(opt.id)} style={{
                  ...
                  <span style={{ fontSize: '20px', flexShrink: 0, marginTop: '1px' }}>{opt.icon}</span>
                  <div style={{ flex: 1 }}>
            ...
            <div style={{ background: t.surface, border: `1px solid ${t.border}`, borderRadius: '20px', padding: '24px', width: '100%', maxWidth: '400px' }} className="animate-scaleIn">
              ...
              {rideModalStep === 'share' && (<>
                <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '16px' }}>
                  <div style={{ width: '44px', height: '44px', borderRadius: '12px', background: 'rgba(99,102,241,0.15)', border: '1px solid rgba(99,102,241,0.3)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '22px', flexShrink: 0 }}>🚀</div>
                  <div>
                ...
                <div style={{ display: 'flex', gap: '10px' }}>
                  ...
                  <button onClick={submitSharePost} className="btn-press" style={{ flex: 2, background: 'linear-gradient(135deg, #3b82f6, #6366f1)', border: 'none', color: 'white', borderRadius: '10px', padding: '13px', cursor: 'pointer', fontSize: '14px', fontFamily: "'Barlow', sans-serif", fontWeight: 700 }}>Jetzt posten 🏍️</button>
                </div>
              </>)}
